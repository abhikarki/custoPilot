        ...
        <section className="p-8 sm:p-10">
          ...
          <div className="mt-4 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-500">Demo Credentials</p>
                <p className="mt-1 text-xs text-slate-600">admin@custopilot.com / admin123</p>
              </div>
              <button
                type="button"
